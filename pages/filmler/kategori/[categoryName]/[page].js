  ...
  return (
    <Container fluid style={{ paddingLeft: 0, paddingRight: 0 }}>
      <Head>
        ...
        <meta
          name="description"
          content="Filmbul.org - En güncel film önerileri, fragmanlar, film bilgileri. Beğendiğin filmleri seç izlemen sana özel film önerilerini al !"
        />
      </Head>
...
export async function getServerSideProps({ query }) {
  ...
  const res = await fetch(`https://api.themoviedb.org/3/discover/movie?api_key=94ec2f0211fe06a3b2bc9827439383d8&language=tr-TR&sort_by=popularity.desc&include_adult=false&include_video=false&page=${page}
  &release_date.lte=${today}&with_genres=${categoryId}`);
